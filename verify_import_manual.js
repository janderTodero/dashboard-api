...
async function runVerification() {
    try {
        ...
        let body = `--${boundary}\r\n`;
        body += `Content-Disposition: form-data; name="file"; filename="test_bank_statement.csv"\r\n`;
        body += `Content-Type: text/csv\r\n\r\n`;
        // We need to combine string and buffer. 
        // Simplest way in Node without Buffer.concat complexity for mixed types is to just use Buffer.concat
